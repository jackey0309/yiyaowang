...
var ExtractTextPlugin = require('extract-text-webpack-plugin') /* 一个可以插入 html 并且创建新的 .html 文件的插件 */
...
var webpackConfig = merge(baseWebpackConfig, {
    ...
    output: {
        ...
        /* 编译输出文件名 */
        filename: utils.assetsPath('js/[name].js'),// 我们可以在 hash 后加 :6 决定使用几位 hash 值
        // 没有指定输出名的文件输出的文件名
